...
public class ItemServiceImpl implements ItemService {
	...
	@Override
	/**
	 * @description : para manipular la lista se usa stream con esto se agrega una funcion landa para agregarle elemento a lista 
	 * 				  y se debe convertir de nuevo a lista
	 */
	public List<Item> findAll() {
		List<Producto> productos = Arrays.asList(clienteRest.getForObject("http://servicio-productos:8001/listar", Producto[].class));
